...
<link media="all" rel="stylesheet" type="text/css" href="${ctx }/static/styles/user.css" />
    ...
    <div id="navigation" class="with-border">
        <div class="user-info">
            ...
            <p>
                <a class="name c666" href="#">Jerryliu</a>
        ...
        <div class="link-bar">
            <a class="link-v1 active" href="/u/163105/likes/">
                喜爱(1)
            </a>
            <span>·</span>
            <a class="link-v1" href="/u/163105/posts/">
                添加(2)
            </a>
            <span>·</span>
            <a class="link-v1" href="/u/163105/notes/">
                点评(3)
            </a>
            <span>·</span>
            <a class="link-v1" href="/u/163105/tags/">
                标签(1)
            </a>

            <label class="right ml15">
                <a href="/u/163105/fans/">
                    关注者 <b>2</b> 人
                </a>
            </label>
            <label class="right">
                <a href="/u/163105/followings/">
                    关注了 <b>1</b> 人
                </a>
            </label>
        </div>
    ...
    <li>
        <div class="image">
            <a href="/detail/7c7956f6/" target=_blank>
    ...
    <li>
        <div class="image">
            <a href="/detail/a0242e3b/" target=_blank>
                <div class="img-mask"></div>
                <img src="http://img02.taobaocdn.com/bao/uploaded/i2/17313019336045204/T1e8z.XeFkXXXXXXXX_!!0-item_pic.jpg_200x200.jpg" alt="无印良品 手动碎纸机" title="无印良品 手动碎纸机"/>
            </a>
        </div>
        


    <div class="like  active" thelink="/entity/like/78036/1/">
        <span></span>喜爱&nbsp;<em>2230</em>
    </div>
    ...
    <li>
        <div class="image">
            <a href="/detail/6c83b12d/" target=_blank>
                <div class="img-mask"></div>
                <img src="http://img04.taobaocdn.com/bao/uploaded/i4/755924341/T20Mi.XcFXXXXXXXXX_!!755924341.jpg_200x200.jpg" alt="Lazerwood Industries MacBook Pro 木质键盘贴" title="Lazerwood Industries MacBook Pro 木质键盘贴"/>
            </a>
        </div>
        


    <div class="like  active" thelink="/entity/like/82211/1/">
        <span></span>喜爱&nbsp;<em>670</em>
    </div>
