...
<div class="entity-detail">
    <label>品牌</label>
    <label class="ml90">商品名称</label>
    <br />
    <input type="text" id="new-entity-brand" name="brand" value="如果有" defaultValue="如果有"/>
    <input type="text" id="new-entity-name" name="title" value="${item.title }" />

    <h4 id="brand-name"><span></span><span>${item.title }</span></h4>
...
<div class="notes with-border">
    <div class="note new-note">
        ...
        <form action="${ctx}/entity/new/" id="add-form" method="post">
            ...
            <em class="error add-error"></em>
            <input class="btn-v2 right" type="submit" value="发表" />
        </form>
