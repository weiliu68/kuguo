...
<html style="overflow-x: hidden; overflow-y: scroll;" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="like " thelink="/entity/like/81303/0/">
        <span></span>喜爱&nbsp;<em>0</em>
            ...
            <p class="with-tag">写点评  #加标签</p>
            <div class="link-row">
                <span class="time left">2013 年 4 月 29 日</span>
            ...
            <div class="comments">
                ...
                <div class="new-comment">
                    <form action="/entity/note/comment/create/" class="new-comment-form" method="post" onsubmit="return false;">
                        <input name="entity_note_id" type="hidden" value="146454" /> 
                ...
                <div id="items-loading"><a href="javascript:void(0);">点击加载更多</a></div>
            </div>
