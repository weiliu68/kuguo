...
<html style="overflow-x: hidden; overflow-y: scroll;" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="image item-image">
        <a href="/detail/4dd1acc1/" target=_blank>
            ...
            <img src="http://img02.taobaocdn.com/bao/uploaded/i2/12188022137478940/T1EBGhXw8iXXXXXXXX_!!0-item_pic.jpg_120x120.jpg" />
        </a>
    </div>
    ...
    <a href="javascript:void(0);" thelink="/user/follow/163345/0/" class="btn-v1 followBtn s1 w4">
        <span></span>
        <em>关注</em>
    </a>
        ...
        <div class="avatar">
            <a href="/u/163345/likes/" target=_blank>
                <img src="http://image.guoku.com/avatar/default_small_8.png" width="50" height="50" />
    ...
    <a href="javascript:void(0);" thelink="/user/follow/69567/1/" class="btn-v1 w4 followBtn s3">
        <span></span>
        <em>取消关注</em>
    </a>
        ...
        <div class="avatar">
            <a href="/u/69567/likes/" target=_blank>
                <img src="http://image.guoku.com/avatar/small_69567_b6a015dbd91b22c31717939a0ab6f325.jpg" width="50" height="50" />
